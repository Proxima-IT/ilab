  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        to: "/admin/qna",
        label: "Q&A",
        description: "Student lesson questions",
        icon: MessageCircle,
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: "Notifications",
        description: "Send student alerts",
        icon: BellRing,
        allowedRoles: ["super_admin", "admin", "manager", "instructor", "content_manager"],
      },
      {
    ...
    items: [
      {
        ...
        icon: Newspaper,
        allowedRoles: ["super_admin", "admin", "manager", "content_manager"],
      },
      {
        to: "/admin/events",
        label: "Events",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Role access overview",
        icon: LockKeyhole,
        superOnly: true,
      },
      {
